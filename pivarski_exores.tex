...
%% \begin{center}
%% \only<1>{\includegraphics[width=0.9\linewidth]{basic_picture.pdf}}
%% \only<2>{\includegraphics[width=0.9\linewidth]{basic_picture2.pdf}}
%% \only<3>{\includegraphics[width=0.9\linewidth]{basic_picture3.pdf}}
%% \end{center}
...
\mbox{ }\hfill \includegraphics[width=0.4\linewidth]{respeak_omega_barrel.pdf} \hfill
\includegraphics[width=0.4\linewidth]{respeak_phi_barrel.pdf} \hfill \mbox{ } \\
\mbox{ }\hfill \includegraphics[width=0.4\linewidth]{respeak_jpsi_barrel.pdf} \hfill
...
\hfill \includegraphics[height=3.5 cm]{dimudimu_control_eventdisplay.png}
...
\mbox{ } \hfill \includegraphics[height=3 cm]{template__bg_sh_b1t__m_1_log.png} \hfill \includegraphics[height=3 cm]{b1_2dpdf.pdf} \hfill \mbox{ }
\end{frame}
